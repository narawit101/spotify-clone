...
import Artis from "@/data/mokpopartis.json";

export default function PoppulaArtis() {
    ...
    return (
        <div>
            <div className='flex justify-between'>
                <a className='text-2xl hover:underline decoration-solid font-bold ml-2' href="#">ศิลปินยอดนิยม</a>
            ...
            <div className="relative group/slider">
                ...
                <div ref={scrollRef}
                    className='mt-3 pb-4 flex gap-2.5 overflow-x-auto whitespace-nowrap scrollbar-hide'>
                    {Artis.map((artis: any) => (
                        <div key={artis.id} className='relative group/card flex flex-col flex-none gap-2.5 p-2 hover:bg-[#28282883] rounded-lg cursor-pointer transition'>
                            <img src={artis.image}
                                className=' flex items-center justify-center rounded-full shadow-lg aspect-square object-contain'
                                width={165}
                                height={165}
                                alt="" />
                            <div
                                className='absolute bottom-18 right-4 bg-[#1ed760] p-3 rounded-full  opacity-0 translate-y-3
                            ...
                            <div className='flex flex-col gap-2 mt-1'>
                                <p className='w-40 line-clamp-2 font-bold hover:underline decoration-solid'>{artis.name}</p>
                                <p className='font-light text-[14px] text-[#bab9b9] w-40 line-clamp-2 hover:underline decoration-solid'>{artis.role} </p>
                            </div>
                        </div>
                    ))}
                </div>
