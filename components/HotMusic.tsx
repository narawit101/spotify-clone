...
import Artis from "@/data/mokartis.json";
    ...
    return (
        <div >
            <div className='flex justify-between'>
                <a className='text-2xl hover:underline decoration-solid font-bold ml-2' href="#">เพลงมาแรง</a>
                ...
                <div ref={scrollRef}
                    ...
                    {Artis.map((artis: any) => (
                        <div key={artis.id} className='relative group/card flex flex-col flex-none gap-2.5 p-2 hover:bg-[#28282883] rounded-lg cursor-pointer transition'>
                            <img src={artis.image}
                                className=' flex items-center justify-center rounded-md aspect-square object-cover '
                                width={170}
                                height={170}
                                alt="" />
                            <div
                                className='absolute bottom-21.5 right-4 bg-[#1ed760] p-3 rounded-full  opacity-0 translate-y-3
                            ...
                            <div className='flex flex-col gap-2 '>
                                <p className='w-40 line-clamp-2 hover:underline decoration-solid'>{artis.music}</p>
                                <p className='font-light text-[14px] text-[#bab9b9] w-40 line-clamp-2 hover:underline decoration-solid'>{artis.name} </p>
                            </div>
                        </div>
                    ))}
                </div>
