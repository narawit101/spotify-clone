...
import Radio from "@/data/mokradio.json";
    ...
    return (
        <div>
            <div className='flex justify-between'>
                <a className='text-2xl hover:underline decoration-solid font-bold ml-2' href="#">สถานีวิทยุยอดนิยม</a>
                    ...
                    {Radio.map((artis: any) => (
                        <div key={artis.id} className='relative group/card flex flex-col flex-none gap-2.5 p-2 hover:bg-[#28282883] rounded-lg cursor-pointer transition'>
                            ...
                            <div className='w-40 mt-1'>
                                <p className='font-light text-[14px] text-[#bab9b9] line-clamp-2'>{artis.name} </p>
                            </div>
                        </div>
                    ))}
                </div>
